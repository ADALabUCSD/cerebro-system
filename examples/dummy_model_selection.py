...
store = LocalStore(prefix_path='/tmp/cerebro')

# # first you need to set virables: export CLASSPATH=`$HADOOP_HOME/bin/hadoop classpath --glob`
# store = HDFSStore(prefix_path='hdfs://master:9000/tmp/cerebro')
...
keras_model.save("/tmp/cerebro_ckpt")
